...
keywords: 
  ...
  - planning accuracy
  - decision making
abstract: "Effective communication of energy consumption information is crucial for promoting residential energy conservation. This research, encompassing two experiments, investigated the influence of presenting energy-saving targets as absolute units (kilowatt-hours, kWh), percentages, or derived monetary values (U.S. dollars) on the precision of conservation plans. Participants completed a simulated household planning task, allocating energy usage reductions across various appliances to meet a specified goal format. Convergent results across experiments indicated that framing reduction goals in absolute kWh units yielded significantly greater planning accuracy compared to both percentage-based and monetary formats. Additionally, higher energy literacy consistently correlated with enhanced planning precision irrespective of format. These findings suggest that utilizing absolute units like kWh is more efficacious for communicating energy-saving goals intended to support detailed planning, while also underscoring the potential utility of interventions aimed at improving consumer energy literacy."
---

# Introduction

Energy insecurity has emerged as a critical public health concern, especially among low-income households, who frequently face difficult choices between paying energy bills and meeting other essential needs [@bednarRecognitionResponseEnergy2020; @memmottSociodemographicDisparitiesEnergy2021]. Such households often experience unsafe coping strategies (e.g., foregoing heating during winter months), which disproportionately burden at-risk populations and heighten risks of utility disconnection  [@memmottSociodemographicDisparitiesEnergy2021]. Moreover, residential energy use contributes to climate change, intensifying the urgency for sustainable solutions [@farghaliStrategiesEnergyContext2023]. 


Given the relevance of promoting behavior change to reduce energy consumption, numerous research efforts have focused on identifying determinants of energy behavior and designing interventions to effectively reduce consumption. Interventions providing tailored energy use information and feedback, often coupled with specific energy-saving goals, have shown promise in achieving measurable reductions in consumption and improving related knowledge, as exemplified by findings from @abrahamseEffectTailoredInformation2007 where households receiving such interventions decreased direct energy use significantly more than controls.

However, the success of such interventions may hinge on how effectively energy information is communicated, with format and presentation context significantly influencing understanding and action [@canfieldPerceptionsElectricityuseCommunications2017; @fischerFeedbackHouseholdElectricity2008]. Consequently, the present study investigates whether presenting energy reduction goals in different numerical representations (e.g., absolute units vs. relative percentages vs. monetary values) systematically influences the accuracy with which consumers can develop corresponding conservation plans. 

### Representation Formats

Although many residents voice concern about energy use, their factual understanding and day‑to‑day behaviors often lag behind that concern, a misalignment documented by @dewatersEnergyLiteracySecondary2011. This knowledge‑action gap highlights the practical need to present utility information in ways that help consumers convert abstract goals into concrete plans. Addressing the role of information presentation in this context, @canfieldPerceptionsElectricityuseCommunications2017 presented participants with hypothetical electricity bills containing various data (e.g., historical usage, neighbor comparisons, appliance breakdowns) across different formats (tables, bar graphs, icon graphs). Their results showed that tables tended to be the most comprehensible format for evaluating energy use information, and that historical electricity use details prompted the highest intentions for energy savings, irrespective of format. Furthermore, @canfieldPerceptionsElectricityuseCommunications2017 found that higher energy literacy consistently correlated with better understanding of energy-related information across all representation types. 
...
How information is numerically framed shapes comprehension and subsequent choices.  Of particular relevance are reference class effects, which occur when numerical statements are presented without a clear or intuitive basis for comparison, making it difficult to infer meaningful quantities [@gigerenzerSimpleToolsUnderstanding2003; @reimerNumericCommunicationRisk2015]. A large body of prior research suggests that presenting data in terms of absolute counts or frequencies, as opposed to probabilities or percentages, can promote more accurate comprehension and facilitate decision making. However, it is important to note that even intuitive formats can pose challenges. For instance, @weberWhyCanOnly2018 found that individuals often struggle with reasoning tasks presented in natural frequencies because they inadvertently revert to more complex probabilistic thinking. 

Unit selection and display format can also influence energy decisions.  For instance, tables are generally more effective than graphs for conveying specific electricity usage data because they facilitate straightforward point reading  [@canfieldPerceptionsElectricityuseCommunications2017]. Furthermore, the framing of energy costs, such as displaying monthly rather than daily or yearly expenses, can significantly affect consumers' choices [@gillConsumerMatchingCosts2022]. Because kilowatt‑hours (kWh) constitute a linear, appliance‑level metric, they can streamline arithmetic and facilitate cross‑appliance comparison. In contrast, many consumers have a preference for receiving energy feedback in terms of monetary values over scientific units [@karjalainenConsumerPreferencesFeedback2011; @nematiImpactInformationbasedInterventions2020], as well as better long-term appliance selection with information presented in monetary terms [@blaschBoundedlyRationalConsumers2019]. However, it remains uncertain how these reported benefits might generalize to the more complex task of household energy planning, where usage patterns are multifaceted and subject to a variety of contextual influences.

### Overview of Current Research

While prior studies have examined communication strategies and format effects related to energy use, the specific question of how different numerical representations impact consumers' ability to formulate precise energy conservation plans remains largely unexplored. A particular gap exists in understanding whether presenting energy-saving goals using absolute units (kWh), relative percentages, or derived monetary values (USD) influences the accuracy of planning appliance-specific reductions. The present research directly confronts this issue,  investigating how these distinct information formats (kWh, percentage, and USD) affect the accuracy of energy-planning decisions. Through manipulation of the presentation format, this study seeks to clarify the relationship between representational choices and planning precision. Drawing upon the reviewed literature, we hypothesized that: 1) Presenting energy reduction goals in absolute units (kWh) will lead to greater planning accuracy compared to percentage-based or monetary formats, as absolute units provide a more direct and less ambiguous representation of energy quantities. 2) Higher energy literacy will be associated with more accurate planning, as individuals with greater energy knowledge may be better equipped to process and utilize the provided information, regardless of format. We also examined the potential of several exploratory variables, such as goal difficulty and the rounding of numerical values, to further elucidate the factors that influence planning accuracy.
...
In Experiment 2, 196 participants were recruited from Amazon Mechanical Turk, and six were excluded because their error magnitudes were statistical outliers (error magnitudes exceeding 2.5 standard deviations from the group mean), leaving a final sample of 190 participants (102 males, 88 females, with an average age = 35.5, SD=9.5)
...
See @tbl-s2-agg for a breakdown of the descriptive statistics, and @fig-s2-log-dist for visualizations of the full error distributions. The ordinal regression analysis (see @tbl-s2-reg) revealed that the USD reference class significantly increased the odds of higher error categories compared to the kWh reference class (OR = 9.68, 95% CI: [1.69, 53.4]). Participants in the USD condition were therefore substantially more likely to deviate from the target energy reduction goal compared to those in the kWh condition. In contrast, the Percentage condition’s odds ratio relative to kWh was more uncertain (OR = 2.78, 95% CI: [0.53, 15.0]), indicating that although there may be a trend toward reduced accuracy in the Percentage condition, the evidence was not definitive (@tbl-s2-ord). Posterior predictive checks are shown in @fig-s2-ppd. 
...
The principal aim of this research was to investigate how the numerical format used to convey energy reduction goals influences consumers' capacity to formulate accurate, appliance-level energy conservation plans. Across two experiments employing a simulated household planning task, the findings consistently demonstrated a significant advantage for presenting goals in absolute, physical units. Specifically, framing reduction targets in kilowatt-hours (kWh) resulted in markedly greater planning accuracy compared to conditions where equivalent goals were presented as percentages or in monetary terms (USD). This primary finding proved robust across variations in hypothetical family household scenarios and secondary task manipulations, including goal difficulty (Exp 2: 10% vs. 15% reduction) and the precision of provided baseline data (Exp 2: exact vs. rounded values).

The observed superiority of the kWh format may be understood through several complementary frameworks, primarily centered on cognitive load and representational compatibility. The kWh format may minimize cognitive load, primarily through maximizing unit consistency inherent within the planning task itself [@swellerCognitiveLoadProblem1988]. Participants were required to manipulate appliance usage figures invariably presented in kWh, performing subtractions from baseline usage, allocating targeted reductions, and summing resultant changes. When the reduction goal was expressed in kWh, this direct correspondence between the target unit and the operational data obviated the necessity for intermediate unit conversions. Furthermore, given that kWh function as a direct, linear metric of energy consumption, their use potentially circumvents cognitive biases documented with non-linear efficiency metrics [@larrickMPGIllusion2008] and might serve more effectively as a 'default unit' [@herberzKiloWhatDefault2020] for this particular planning context, thereby grounding the goal in a more readily manipulable quantity. Kilowatt-hours, while perhaps less universally familiar than monetary units in everyday discourse for some consumers, nonetheless represent the fundamental unit of electricity consumption frequently encountered on utility bills and appliance labeling.

Conversely, the comparatively diminished performance for Percentage and USD format conditions highlights the cognitive costs potentially incurred due to format incongruence within this specific task. Both alternative formats introduced what might be termed an asymmetric conversion burden: participants first needed to translate the relative (percentage) or derived (monetary) goal into an absolute kWh value prior to engaging with the central task of allocating reductions across kWh-denominated appliance figures. This initial translation step intrinsically elevates cognitive load and introduces a critical juncture prone to calculation errors, particularly considering the documented difficulties many individuals exhibit concerning proportional reasoning [@fisher100BiasEffects2022; @petersNumeracyDecisionMaking2006].

The consistently lowest accuracy observed with the USD format is particularly noteworthy. While monetary feedback is sometimes preferred [@karjalainenConsumerPreferencesFeedback2011; @nematiImpactInformationbasedInterventions2020] or aids certain decisions like cost-based appliance selection [@blaschBoundedlyRationalConsumers2019], our results highlight optimal formatting's task-dependence. For detailed allocation, the required translation from USD to kWh appears to introduce critical computational friction, potentially compounded by reliance on ill-suited cost heuristics [@vandenbroekHeuristicsEnergyJudgement2019].

Secondary findings, primarily emerging from Experiment 2, offer additional, albeit preliminary, insights. The substantial improvement in planning accuracy associated with self-reported calculator use serves to highlight the computational demands inherent in the planning task and illustrates the practical benefits derived from leveraging cognitive offloading tools [@riskoCognitiveOffloading2016]. Importantly, the main effect of information format persists when statistically controlling for calculator. Experiment 2 also tentatively suggested a modest accuracy improvement when baseline usage data were presented using rounded numbers, a finding potentially attributable to reduced processing fluency demands [@nguyenNumbersCanSharpen2022], although this particular effect warrants more dedicated future investigation. Finally, the unexpected, preliminary indication that the ostensibly more challenging 15% reduction goal was associated with slightly enhanced accuracy remains statistically uncertain and necessitates replication before any substantive interpretation can be confidently advanced. Furthermore, in line with [@attariPublicPerceptionsEnergy2010; @canfieldPerceptionsElectricityuseCommunications2017], individuals possessing higher energy literacy consistently demonstrated more accurate planning across all format conditions. 

Although consumers may, under certain circumstances, prefer or derive benefit from monetary energy information (e.g., for global cost assessments, long-term investment decisions), the specific task of precisely planning near-term, appliance-level consumption adjustments seems significantly facilitated when information is presented using the direct, absolute units of energy itself (kWh). This observation aligns with broader research indicating that individuals tend to gravitate towards concrete cues in energy-related judgments [@vandenbroekHeuristicsEnergyJudgement2019] and that interventions furnishing specific heuristics or employing well-chosen "default units" can enhance accuracy and guide more optimal decisions [@herberzKiloWhatDefault2020; @marghetisSimpleInterventionsCan2019]. The current findings suggest, that the selection of information format can itself function as a subtle yet potentially effective "nudge," guiding individuals towards more accurate energy planning by reducing the cognitive burden associated with translating abstract goals into concrete, actionable steps. This work extends prior investigations into the effects of numerical format within comprehension and decision-making contexts [@gigerenzerSimpleToolsUnderstanding2003; @reimerNumericCommunicationRisk2015] by demonstrating the persistence of such format-dependent effects within a more complex, goal-directed planning paradigm necessitating multi-step calculation and resource allocation, as opposed to simpler estimation or choice tasks. 



## Limitations and Future Directions

Several limitations in the current studies should be considered when interpreting these findings. Real‑world conservation decisions occur amid comfort trade‑offs, fluctuating prices, and social norms -  all of which are factors absent from our controlled tasks. Consequently, planning accuracy in this paradigm may not perfectly predict the efficacy of planning or subsequent behavior change in naturalistic environments. Additionally, our primary outcome measure of planning accuracy does not capture other potentially important dimensions such as the perceived feasibility or acceptability of the generated plan. Finally, the Percentage and USD conditions required an additional calculation step compared to the kWh condition - though we argue that these additional computations reflect a practical reality of using these formats for this task. 

Additionally, although we recorded whether participants used calculators, we could not control how thoroughly they engaged in mathematical computations, nor could we track other external resources they might have consulted.

These limitations, alongside the core findings, suggest several avenues for future research. Among these is the need for field experiments to ascertain whether the planning accuracy benefits conferred by the kWh format translate into demonstrable, sustained energy savings in real households facing actual constraints and consequences. Investigating the interplay between information format and individual differences beyond general energy literacy (e.g., factors such as numeracy, financial literacy, cognitive style, and motivational orientations) could reveal moderating factors and facilitate the development of more precisely tailored communication strategies. Employing process-tracing methodologies, such as think-aloud protocols, would afford valuable insights into the specific cognitive strategies, heuristics, and experienced cognitive load elicited by different formats, thereby further elucidating the mechanisms underpinning the observed accuracy discrepancies.

## Conclusion

In conclusion, this research provides clear evidence that the numerical format chosen to communicate energy-saving goals exerts a significant influence on the accuracy with which consumers can develop conservation plans. Framing reduction targets in absolute, linear consumption units (kWh) - the standard unit for quantifying electricity usage  enhances planning accuracy compared to relative percentages or derived monetary values (USD).  Although future work is needed to validate these results in authentic, real-world contexts and across broader demographic samples, the present findings provide strong evidence that absolute consumption metrics (e.g., kWh) can substantially enhance the precision and potentially the effectiveness of residential energy planning.
