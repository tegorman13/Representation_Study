...
#| apa-note: "The table shows the percentage of participants who fell into each accuracy level for each reference class condition (percentages of kWh, $, and USD columns reflect within condition percentages). "
...
::: {#tbl-s2-reg apa-note="Ordinal regression results. Positive coefficients for the reference class predictors indicate that those conditions are associated with higher error categories relative to the kWh baseline."}
|Parameter          |Estimate |CI_Lower |CI_Upper |pd   |
|:------------------|:--------|:--------|:--------|:----|
