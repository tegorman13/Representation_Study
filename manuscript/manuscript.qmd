...
```{r}
#| label: tbl-s1-prop
#| tbl-cap: "Study 1: Descriptive Performance"
...
::: {#tbl-s2-agg apa-note="The table shows performance as both the % of trials where participants matched the goal, and the mean absolute error from the target reduction goal."}
