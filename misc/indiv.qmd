...
# and a data frame 's2_agg1' with planning data
...
s2_long <- merge(s2_long, s2_agg1[, c("id", "els")], by = "id")
...
# Merge energy literacy scores
s2_long <- s2_long |> left_join(s2_agg1, by = c("id", "refClass", "calc", "state", "pct", "pct_goal", "plan", "rounded", "els"))
