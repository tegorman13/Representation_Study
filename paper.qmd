...
<iframe src="/manuscript/output/manuscript.html" frameborder="0" style="overflow:hidden;height:88%;width:100%;border:2px solid #ccc;" height="88%" width="100%" name="manuscript"></iframe>
```