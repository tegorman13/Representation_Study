...
breakdown of the descriptive statistics, and
<a href="#fig-s2-log-dist" class="quarto-xref">Figure 5</a> for
visualizations of the full error distributions. The ordinal regression
analysis (see <a href="#tbl-s2-reg" class="quarto-xref">Table 6</a>)
...
was not definitive
(<a href="#tbl-s2-ord" class="quarto-xref">Table 7</a>). Posterior
predictive checks are shown in
<a href="#fig-s2-ppd" class="quarto-xref">Figure 7</a>.
